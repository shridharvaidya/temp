...
const express = require("express") // to make server (backend )
const mongoose = require("mongoose") //database connection 
const StudentMarks = require("./StudentMarks") //model
const app = express() //express aapplication 
...
const db_connection = "mongodb+srv://admin:admin@cluster0.msqfeub.mongodb.net/student?retryWrites=true&w=majority"
const port = 3000
// mongodb+srv://admin:<password>@cluster0.msqfeub.mongodb.net/?retryWrites=true&w=majority // password =admin db=student 
// mine =>         "mongodb+srv://admin:admin@cluster0.msqfeub.mongodb.net/student?retryWrites=true&w=majority"

//original =>      "mongodb+srv://admin:admin@cluster1.ujwzkvp.mongodb.net/statement1_student?retryWrites=true&w=majority"
...
app.put("/update10Marks/:studentID", async function (request, response) {
    ...
    response.send(student)// inc ==increment 
})
